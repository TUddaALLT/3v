(function (jQuery) {
    ...
    if (jQuery(".portfolio-container").length > 0) {
      jQuery(".portfolio-container").each(function () {
        var $this = jQuery(this),
          ...
          $columnWidth,
          $gutter_width = Number(
            $this.closest(".portfolio").attr("data-gutter-width"),
          );
        ...
        $this.imagesLoaded(function () {
          if (
            $this.closest(".portfolio").hasClass("full-screen-gutter") &&
            Number($this.closest(".portfolio").attr("data-masonry")) !== 1
          ) {
            jQuery(
              $this
                .find(".element.wide-width-height, .element.wide-height")
                .find(".element-inner .flip-wrap .flip-img-wrap"),
            ).height(
              $this
                .find(".element.no-wide-width-height:visible")
                .find(".flip-wrap")
                .height() *
                2 +
                $gutter_width,
            ...
            $this
              .find(
                ".element.wide-width-height, .element.wide-height, .element.wide-width",
              )
              .find(".element-inner .flip-wrap .flip-img-wrap img")
              .resizeToParent();
          }
          $this
            .isotope({
  ...
  function arrange_animate_icon() {
    jQuery(".animate-icon-module-style1").each(function () {
      var $this = jQuery(this),
        ...
        $item_width;
      $width = Number(
        $this.closest(".animate-icon-module-style1-wrap-container").width(),
      );
    ...
    jQuery(".animate-icon-module-style2").each(function () {
      ...
      $normal_content_height = Number(
        $this.find(".animate-icon-module-style2-normal-content").height(),
      );
      $hover_content_height = Number(
        $this.find(".animate-icon-module-style2-hover-content").height(),
      );
      ...
      $this
        ...
        .css("padding-top", $module_height - $normal_content_height / 2);
  ...
  function be_custom_scroll_animation() {
    ...
    if (jQuery(".portfolio-container.portfolio-item-parallax").length > 0) {
      if (
        ...
        jQuery(".portfolio-container.portfolio-item-parallax").each(
          function () {
  ...
  function do_ajax_complete() {
    ...
    if (
      ...
      jQuery(".be-section.be-bg-parallax").length > 0
    ) {
    ...
    if (
      jQuery(".trigger_infinite_scroll.portfolio_infinite_scroll").length > 0
    ) {
      jQuery(".trigger_infinite_scroll.portfolio_infinite_scroll").each(
        function () {
          var $this = jQuery(this),
            $action = $this.closest(".portfolio").attr("data-action"),
            $col = $this.closest(".portfolio").attr("data-col"),
            $data_gutter_width = Number(
              $this.closest(".portfolio").attr("data-gutter-width"),
            ),
            ...
            $show_filters = $this
              .closest(".portfolio")
              .attr("data-show_filters"),
            $data_thumbnail_bg_color = $this
              .closest(".portfolio")
              .attr("data-thumbnail-bg-color"),
            $data_title_style = $this
              .closest(".portfolio")
              .attr("data-title-style"),
            $data_title_color = $this
              .closest(".portfolio")
              .attr("data-title-color"),
            $data_cat_color = $this
              .closest(".portfolio")
              .attr("data-cat-color"),
            $title_animation_type = $this
              .closest(".portfolio")
              .attr("data-title-animation-type"),
            $cat_animation_type = $this
              .closest(".portfolio")
              .attr("data-cat-animation-type"),
            $img_grayscale = $this
              .closest(".portfolio")
              .attr("data-img-grayscale"),
            $image_effect = $this
              .closest(".portfolio")
              .attr("data-image-effect"),
            $gradient_style_color = $this
              .closest(".portfolio")
              .attr("data-gradient-style-color"),
            $data_hover_style = $this
              .closest(".portfolio")
              .attr("data-hover-style"),
                ...
                .done(function (data) {
                  if (data !== 0 && data !== "0" && data) {
                    ...
                    $newItems.imagesLoaded(function () {
                      ...
                      be_lightbox();
                      jQuery(".element.style3-hover .element-inner").each(
                        function () {
                          jQuery(this).hoverdir();
                        },
                      );
                      jQuery(".element.style4-hover .element-inner").each(
                        function () {
                          jQuery(this).hoverdir({
                            inverse: true,
                          });
                    ...
                    $newItems.find(".be-flex-slider").each(function () {
                      var $animation_type = jQuery(this).attr("data-animation"),
                        ...
                        $slide_interval = Number(
                          jQuery(this).attr("data-slide-interval"),
                        );
                      ...
                      jQuery(this).flexslider({
                        start: function (slider) {
                          slider
                            .closest(".be-flex-slider")
                            .removeClass("flex-loading");
                          slider
                            .closest(".be-flex-slider")
                            .find(".loader-icon")
                            .remove();
                          if (slider.find("ul.slides li").length < 2) {
                            slider
                              .closest(".be-flex-slider")
                              .find(".flex-control-nav,.flex-direction-nav")
                              .remove();
                          }
                          if (
                            slider.closest(".portfolio-container").length > 0
                          ) {
                            jQuery(window).trigger("resize");
                          }
                        },
      ...
      if (jQuery(".be-carousel").length > 0) {
        jQuery(".be-carousel:not(.portfolios-carousel)").each(function () {
          var $this = jQuery(this),
            ...
            $max,
            $slideshow = Number($this.attr("data-slide-show"), 10),
      ...
      if (jQuery(".flexslider.content-flex-slider").length > 0) {
        jQuery(".flexslider.content-flex-slider").each(function () {
          var $this = jQuery(this),
            ...
            $animation_type = $this.attr("data-slide-animation-type"),
            $i = 0,
            $control_nav_length = $this
              .find(".slides")
              .find(".testimonial_slide").length,
            $controls,
            $append = "";
  ...
  jQuery(document).ready(function () {
    ...
    jQuery(document).on("click", ".sort", function () {
      var $this = jQuery(this),
        myClass = $this.attr("data-id");
      $this.closest(".filters").find(".sort").removeClass("current_choice");
      $this.addClass("current_choice");
      $this
        .closest(".portfolio")
        .find(".portfolio-container")
        .isotope({ filter: "." + myClass });
    });
    jQuery(document).on(
      "mouseenter",
      ".style1-hover .element-inner",
      function () {
    ...
    jQuery(document).on(
      "click",
      ".trigger_load_more.portfolio_load_more:not(.disabled)",
      function () {
        var $this = jQuery(this),
          $action = $this.closest(".portfolio").attr("data-action"),
          $col = $this.closest(".portfolio").attr("data-col"),
    ...
    jQuery(document).on("click", ".mail-chimp-submit", function () {
      var $this = jQuery(this),
        $subscribe_status = $this
          .closest(".mail-chimp-wrap")
          .find(".subscribe_status"),
        $subscribe_loader = $this
          .closest(".mail-chimp-wrap")
          .find(".subscribe_loader");
      ...
      jQuery.ajax({
        ...
        data:
          ...
          jQuery(this).closest(".mail-chimp-form").serialize(),
        success: function (msg) {
    ...
    jQuery(document).on("mouseenter", ".be-button", function () {
      ...
      if (
        !(
          jQuery("html").hasClass("cssgradients") &&
          (jQuery(this).hasClass("bg-animation-slide-top") ||
            jQuery(this).hasClass("bg-animation-slide-left") ||
            jQuery(this).hasClass("bg-animation-slide-bottom") ||
            jQuery(this).hasClass("bg-animation-slide-right"))
        )
      ) {
    ...
    jQuery(document).on(
      ...
      function () {
        ...
        $this
          .find(".animate-icon-title")
          .css("color", $this.attr("data-hover-title-color"));
        $this
          .find(".animate-icon-icon")
          .css("color", $this.attr("data-hover-icon-color"));
        if (
          $this.find(".animate-icon-module-style2-hover-content").height() < 1
        ) {
          $distence = 4;
        }
        jQuery(this)
    ...
    jQuery(document).on(
      ...
      function () {
        ...
        $this
          .find(".animate-icon-title")
          .css("color", $this.attr("data-title-color"));
        $this
          .find(".animate-icon-icon")
          .css("color", $this.attr("data-icon-color"));
    ...
    jQuery(document).on(
      "mouseenter",
      ".animate-icon-module-style1.be-bg-overlay",
      function (e) {
        var $this = jQuery(this);
        $this
          .find(".section-overlay")
          .css(
            "background-color",
            $this.find(".section-overlay").attr("data-hover-bg-color"),
          );
      },
    );
    jQuery(document).on(
      ...
      function (e) {
        ...
        $this
          ...
          .css(
            "background-color",
            $this.find(".section-overlay").attr("data-default-bg-color"),
          );
      },
    );
